        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="card">
                    <div class="card-body">
                        @if(auth()->id() == $blog->user_id)
                            <div class="text-right"><a href="{{ route('blog.edit', $blog) }}" class="btn btn-primary btn-sm">Edit</a></div>
                        @endif
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body" id="comment-list">
                        ...
                        @empty
                            <div id="empty" class="text-center py-3 text-muted">No comments yet...</div>
                        @endforelse
                    </div>
                </div>
                        ...
                        <div class="card-body pb-2">
                            <form id="form-comment" method="post" action="{{ route('blog.comment', $blog) }}">
                                ...
                                <div class="text-right">
                                    <button id="btn-comment" type="button" class="btn btn-primary btn-sm px-5">Comment</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body pb-2">
                            <div class="alert alert-warning" role="alert">
                                ...
                                <a href="{{ route('login') }}" class="btn btn-primary btn-sm py-1 px-4 ml-3">Login</a>
                            </div>
                        </div>
                    </div>
                @endauth
            ...
            <div class="col-sm-3 p-0">
                @include('common.right-card', [
                      ...
                      'content' => 'Internship position on ' . $blog->category->name . '',
