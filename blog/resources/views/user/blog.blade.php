                                ...
                                <div class="mt-2 d-flex justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="custom-control custom-switch mr-3">
                                            ...
                                            <label class="custom-control-label text-muted" style="font-size: 14px;" for="status-{{ $blog->id }}">Publish or not</label>
                                        </div>
                                        <a href="{{ route('blog.edit', $blog) }}" class="btn btn-sm py-0 px-3 btn-primary">Edit</a>
                                        <a href="javascript:" data-url="{{ route('blog.destroy', $blog) }}" class="del-blog btn btn-sm py-0 px-3 btn-danger ml-2">Delete</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
